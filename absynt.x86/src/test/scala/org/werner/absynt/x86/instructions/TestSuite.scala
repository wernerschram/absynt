  ...
  "a Test instruction" when {
    ...
    "in real mode" should {
      ...
      "correctly encode test WORD PTR [bx], 0x3412" in {
        Test(0x3412.toShort, Pointer.word[WordSize](BX)).encodeByte should be(Hex.lsb("F7 07 12 34"))
      }

      "correctly represent test WORD PTR [bx], 0x3412 as a string" in {
        Test(0x3412.toShort, Pointer.word[WordSize](BX)).toString shouldBe "test WORD PTR [bx], 13330"
      }

      "correctly encode test BYTE PTR [bx], al" in {
        Test(AL, Pointer.word[ByteSize](BX)).encodeByte should be(Hex.lsb("84 07"))
      }

      "correctly represent test BYTE PTR [bx], al as a string" in {
        Test(AL, Pointer.word[ByteSize](BX)).toString shouldBe "test BYTE PTR [bx], al"
      }
    }
    ...
    "in protected mode" should {
      ...
      "correctly encode test DWORD PTR [0x11111111], 0x44332211" in {
        Test(0x44332211, Pointer.doubleWord[DoubleWordSize](0x11111111)).encodeByte should be(Hex.lsb("F7 05 11 11 11 11 11 22 33 44"))
      }

      "correctly represent test DWORD PTR [0x11111111], 0x44332211 as a string" in {
        Test(0x44332211, Pointer.doubleWord[DoubleWordSize](0x11111111)).toString shouldBe "test DWORD PTR [286331153], 1144201745"
      }

      "correctly encode test DWORD PTR [0x1234], edx" in {
        Test(EDX, Pointer.word[DoubleWordSize](0X1234)).encodeByte should be(Hex.lsb("67 85 16 34 12"))
      }

      "correctly represent test DWORD PTR [0x1234], edx as a string" in {
        Test(EDX, Pointer.word[DoubleWordSize](0x1234)).toString shouldBe "test DWORD PTR [4660], edx"
      }
    }
    ...
    "in long mode" should {
      ...
      "correctly encode test QWORD PTR [0x11111111], 0x44332211" in {
        Test(0x44332211, Pointer.doubleWord[QuadWordSize](0x11111111)).encodeByte should be(Hex.lsb("67 48 F7 05 11 11 11 11 11 22 33 44"))
      }

      "correctly represent test QWORD PTR [0x11111111], 0x44332211 as a string" in {
        Test(0x44332211, Pointer.doubleWord[QuadWordSize](0x11111111)).toString shouldBe "test QWORD PTR [286331153], 1144201745"
      }

      "throw an AssertionError for test WORD PTR [0x11111111], 0x44332211" in {
        an[AssertionError] should be thrownBy {
          Test(0x44332211, Pointer.doubleWord[WordSize](0x11111111))
        }
      }
      ...
      "correctly encode test BYTE PTR [rax+rbx*2], 0x11" in {
        Test(0x11.toByte, Pointer.quadWord[ByteSize](RAX+RBX*2)).encodeByte should be(Hex.lsb("F6 04 58 11"))
      }

      "correctly represent test BYTE PTR [rax+rbx*2], 0x11 as a string" in {
        Test(0x11.toByte, Pointer.quadWord[ByteSize](RAX+RBX*2)).toString shouldBe "test BYTE PTR [rax+rbx*2], 17"
      }

      "correctly encode test WORD PTR [rax+rbx*2], 0x2211" in {
        Test(0x2211.toShort, Pointer.quadWord[WordSize](RAX+RBX*2)).encodeByte should be(Hex.lsb("66 F7 04 58 11 22"))
      }

      "correctly represent test WORD PTR [rax+rbx*2], 0x2211 as a string" in {
        Test(0x2211.toShort, Pointer.quadWord[WordSize](RAX+RBX*2)).toString shouldBe "test WORD PTR [rax+rbx*2], 8721"
      }

      "correctly encode test DWORD PTR [rax+rbx*2], 0x44332211" in {
        Test(0x44332211, Pointer.quadWord[DoubleWordSize](RAX+RBX*2)).encodeByte should be(Hex.lsb("F7 04 58 11 22 33 44"))
      }

      "correctly represent test DWORD PTR [rax+rbx*2], 0x44332211 as a string" in {
        Test(0x44332211, Pointer.quadWord[DoubleWordSize](RAX+RBX*2)).toString shouldBe "test DWORD PTR [rax+rbx*2], 1144201745"
      }

      "correctly encode test QWORD PTR [rax+rbx*2], 0x44332211" in {
        Test(0x44332211, Pointer.quadWord[QuadWordSize](RAX+RBX*2)).encodeByte should be(Hex.lsb("48 F7 04 58 11 22 33 44"))
      }

      "correctly represent test QWORD PTR [rax+rbx*2], 0x44332211 as a string" in {
        Test(0x44332211, Pointer.quadWord[QuadWordSize](RAX+RBX*2)).toString shouldBe "test QWORD PTR [rax+rbx*2], 1144201745"
      }

      "correctly encode test BYTE PTR gs:[rax+rbx*2], 0x11" in {
        Test(0x11.toByte, Pointer.quadWord[ByteSize](GS+RAX+RBX*2)).encodeByte should be(Hex.lsb("65 F6 04 58 11"))
      }

      "correctly represent test BYTE PTR gs:[rax+rbx*2], 0x11 as a string" in {
        Test(0x11.toByte, Pointer.quadWord[ByteSize](GS+RAX+RBX*2)).toString shouldBe "test BYTE PTR gs:[rax+rbx*2], 17"
      }

      "correctly encode test WORD PTR es:[rax+rbx*2], 0x2211" in {
        Test(0x2211.toShort, Pointer.quadWord[WordSize](ES+RAX+RBX*2)).encodeByte should be(Hex.lsb("26 66 F7 04 58 11 22"))
      }

      "correctly represent test WORD PTR es:[rax+rbx*2], 0x2211 as a string" in {
        Test(0x2211.toShort, Pointer.quadWord[WordSize](ES+RAX+RBX*2)).toString shouldBe "test WORD PTR es:[rax+rbx*2], 8721"
      }

      "correctly encode test DWORD PTR fs:[rax+rbx*2], 0x44332211" in {
        Test(0x44332211, Pointer.quadWord[DoubleWordSize](FS+RAX+RBX*2)).encodeByte should be(Hex.lsb("64 F7 04 58 11 22 33 44"))
      }

      "correctly represent test DWORD PTR fs:[rax+rbx*2], 0x44332211 as a string" in {
        Test(0x44332211, Pointer.quadWord[DoubleWordSize](FS+RAX+RBX*2)).toString shouldBe "test DWORD PTR fs:[rax+rbx*2], 1144201745"
      }

      "correctly encode test QWORD PTR ss:[rax+rbx*2], 0x44332211" in {
        Test(0x44332211, Pointer.quadWord[QuadWordSize](SS+RAX+RBX*2)).encodeByte should be(Hex.lsb("36 48 F7 04 58 11 22 33 44"))
      }

      "correctly represent test QWORD PTR ss:[rax+rbx*2], 0x44332211 as a string" in {
        Test(0x44332211, Pointer.quadWord[QuadWordSize](SS+RAX+RBX*2)).toString shouldBe "test QWORD PTR ss:[rax+rbx*2], 1144201745"
      }

      "correctly encode test QWORD PTR cs:[eax], 0x44332211" in {
        Test(0x44332211, Pointer.doubleWord[QuadWordSize](CS+EAX)).encodeByte should be(Hex.lsb("2e 67 48 F7 00 11 22 33 44"))
      }

      "correctly represent test QWORD PTR cs:[eax], 0x44332211 as a string" in {
        Test(0x44332211, Pointer.doubleWord[QuadWordSize](CS+EAX)).toString shouldBe "test QWORD PTR cs:[eax], 1144201745"
      }

      "correctly encode test DWORD PTR cs:[rbx], 0x44332211" in {
        Test(0x44332211, Pointer.quadWord[DoubleWordSize](CS+RBX)).encodeByte should be(Hex.lsb("2e F7 03 11 22 33 44"))
      }

      "correctly represent test DWORD PTR cs:[rbx], 0x44332211 as a string" in {
        Test(0x44332211, Pointer.quadWord[DoubleWordSize](CS+RBX)).toString shouldBe "test DWORD PTR cs:[rbx], 1144201745"
      }

      "correctly encode test WORD PTR cs:[rbx], 0x2211" in {
        Test(0x2211.toShort, Pointer.quadWord[WordSize](CS+RBX)).encodeByte should be(Hex.lsb("2e 66 F7 03 11 22"))
      }

      "correctly represent test WORD PTR cs:[rbx], 0x2211 as a string" in {
        Test(0x2211.toShort, Pointer.quadWord[WordSize](CS+RBX)).toString shouldBe "test WORD PTR cs:[rbx], 8721"
      }

      "correctly encode test BYTE PTR cs:[rbx], 0x11" in {
        Test(0x11.toByte, Pointer.quadWord[ByteSize](CS+RBX)).encodeByte should be(Hex.lsb("2e F6 03 11"))
      }

      "correctly represent test BYTE PTR cs:[rbx], 0x11 as a string" in {
        Test(0x11.toByte, Pointer.quadWord[ByteSize](CS+RBX)).toString shouldBe "test BYTE PTR cs:[rbx], 17"
      }
      ...
      "correctly encode test DWORD PTR [rax+rbx*2], 0x44" in {
        an[AssertionError] should be thrownBy {
          Test(0x44.toByte, Pointer.quadWord[DoubleWordSize](RAX+RBX*2))
        }
      }

      "correctly encode test QWORD PTR [rax+rbx*2], 0x44" in {
        an[AssertionError] should be thrownBy {
          Test(0x44.toByte, Pointer.quadWord[QuadWordSize](RAX+RBX*2))
        }
      }

      "correctly encode test BYTE PTR [rbx], al" in {
        Test(AL, Pointer.quadWord[ByteSize](RBX)).encodeByte should be(Hex.lsb("84 03"))
      }

      "correctly represent test BYTE PTR [rbx], al as a string" in {
        Test(AL, Pointer.quadWord[ByteSize](RBX)).toString shouldBe "test BYTE PTR [rbx], al"
      }

      "correctly encode test BYTE PTR [rbx], ah" in {
        Test(AH, Pointer.quadWord[ByteSize](RBX)).encodeByte should be(Hex.lsb("84 23"))
      }

      "correctly represent test BYTE PTR [rbx], ah as a string" in {
        Test(AH, Pointer.quadWord[ByteSize](RBX)).toString shouldBe "test BYTE PTR [rbx], ah"
      }

      "correctly encode test BYTE PTR [rbx], r15l" in {
        Test(R15L, Pointer.quadWord[ByteSize](RBX)).encodeByte should be(Hex.lsb("44 84 3B"))
      }

      "correctly represent test BYTE PTR [rbx], r15l as a string" in {
        Test(R15L, Pointer.quadWord[ByteSize](RBX)).toString shouldBe "test BYTE PTR [rbx], r15l"
      }

      "correctly encode test QWORD PTR [rax], rax" in {
        Test(RAX, Pointer.quadWord[QuadWordSize](RAX)).encodeByte should be(Hex.lsb("48 85 00"))
      }

      "correctly represent test QWORD PTR [rax], rax as a string" in {
        Test(RAX, Pointer.quadWord[QuadWordSize](RAX)).toString shouldBe "test QWORD PTR [rax], rax"
      }
